<template>
  <div class="categories__column">
    <router-link
      :to="'/catalog/' + catalogs.path + '/' + categories_data.categpath"
    >
      <div class="categories__item categ-block">
        <div class="categ-block__img">
          <img
            :src="
              require(`../../../public/img/` +
                catalogs.path +
                `-` +
                categories_data.categpath +
                `.jpg`)
            "
            alt="img"
          />
          <div class="categ-block__btn btn">
            <svg
              width="29"
              height="4"
              viewBox="0 0 29 4"
